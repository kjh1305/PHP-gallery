<?
		...
		function __construct()		//클래스 생성할 때 초기 설정
	{
		...
		$this->load->model("best_m"); //모델 jangbuo_m 연결
		...
		public function lists() // 리스트 함수
	{
		...
		$config["total_rows"] = $this->best_m->rowcount($text1,$text2); //전체 레코드 개수 구하기
		...
		$this->load->view("best_list",$data); //jangbuo_list에 자료전달
