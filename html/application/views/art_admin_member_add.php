                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">추가하기</h3></div>
                                    <div class="card-body">
                                        <form  method="post" action="" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" name="name" type="text" value="<?=set_value("name");?>" placeholder="이름을 입력하세요." />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" name="uid" type="text" value="<?=set_value("uid");?>"  placeholder="ID를 입력하세요." />
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
														...
														value="<?=set_value("pwd");?>"placeholder="비밀번호를 입력하세요." />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
														...
														value="<?=set_value("repwd");?>"type="password" placeholder="한번 더 입력하세요." />
											...
											<div class="form-group">
												...
												value="<?=set_value("tel");?>"placeholder="-빼고 입력하세요. 예) 01012341234" />
											...
											<div class="form-group">
												...
												value=""  placeholder="간단하게 30자 이내로 입력하세요." />
											...
											<div class="form-group">
													...
													<label class="btn btn-primary active">
														<input  type="radio" name="rank" class="form-control py-4" value="0" style="display:none;"> 직원
														</label>
															<label class="btn btn-primary active">
														<input  type="radio" name="rank" class="form-control py-4" value="1" style="display:none;"> 관리자
														</label>
													</div>
											</div>
