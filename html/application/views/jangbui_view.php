...
<tr>
    ...
    <td width="80%" align="left"> <?=$row->numi9;?>
    </td>
</tr>
<tr>
    <td width="20%" class="mycolor2" style="vertical-align:middle">
...
<?	$tmp = $text1 ? "/no/$no/text1/$text1/page/$page" : "/no/$no/page/$page"; ?>
	<div align="center">
		<a href="/~sale9/jangbui/edit<?=$tmp ?>" class="btn btn-sm mycolor1">수정</a>
		<a href="/~sale9/jangbui/del<?=$tmp ?>" class="btn btn-sm mycolor1">삭제</a>
