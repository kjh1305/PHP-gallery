...
<script>
    ...
    <div class="online-w3l-form">
	  ...
	  <div  style="text-align:center;">
									<span class="avatar"><img src="/~sale9/product_img/<?=$row->pic;?>" alt="" /></span>
									</div>
									<br>
        <form action="" method="post" enctype="multipart/form-data">
          <div class="main">
            <div class="form-left-w3l">
              <input type="text" class="top-up" name="name" value="<?=$row->name;?>" placeholder="작품이름" required="">
          ...
          <div class="form-control-w3l">
            <textarea name="exp" placeholder="소개...30자 이내로 쓰시오."><?=$row->exp?></textarea>
          </div>
