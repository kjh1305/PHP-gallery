    ...
    <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
      <div class="container">
        ...
        <ul class="breadcrumbs-custom-path mt-2">
          ...
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span>회원가입</li>
        </ul>
      </div>
    </div>
  </section>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form  method="post" action="/~sale9/art_member_signup/add" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="col-md-12">
											...
											<div class="form-group">
												...
												value=""  placeholder="간단하게 50자 이내로 입력하세요." />
